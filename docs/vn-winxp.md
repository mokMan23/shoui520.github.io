...
5. Click "Customize" again, and set `Standards and Formats` to `Japanese`. Click OK.
6. Enter your Name, Product Key, and Computer Name.
...
9. Before the OOBE (Out-of-Box Experience) starts, you'll see a window. Click `OK` twice to apply the resolution change. 
10. In the OOBE: Click `Next`, `Not Right Now`, `Next`.
...
[MyPal](https://github.com/Feodor2/Mypal68/releases/latest) - Modern browser based off Firefox 68, less resource intensive than Supermium & best for PCs <1GB RAM

## Using ITHVNR for text hooking
!!! info "If you installed Legacy Update, your root certificates are up-to-date."
[ITHVNR](https://drive.proton.me/urls/C2QY84DYX0#vRIWAHdwnAb0) is an XP-supported alternative of Texthooker. [Update your root certificates first](https://github.com/JohnTHaller/RootCertificateUpdatesForLegacyWindows/releases/latest) [(instructions)](https://github.com/JohnTHaller/RootCertificateUpdatesForLegacyWindows#installing-the-certificates),
...
2. Go to the [Texthooker UI Webpage](/texthooker.html).
3. Immerse!
