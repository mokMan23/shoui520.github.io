...
=== "Wine"
	...
	Note: I am not an expert in running VNs on Linux, [but this person is](https://www.vnwiki.xyz/linux/wineprefixes.html#creating-wineprefixes), so I suggest you check out this guide instead.  
